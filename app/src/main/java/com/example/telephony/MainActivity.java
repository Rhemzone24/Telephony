...
public class MainActivity<number1> extends AppCompatActivity {
...
//Onclick Calling Number
    ...
    public void btnCALL(View view) {
        ...
        call.setData(Uri.parse("tel:09458171954"));
    ...
    public void bnCALL(View view) {
        Intent call = new Intent(Intent.ACTION_CALL);
        call.setData(Uri.parse("tel:09452241662"));
        if (ActivityCompat.checkSelfPermission(MainActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            return;
        }
        startActivity(call);
    ...
    public void btCALL(View arg0) {
        Intent call = new Intent(Intent.ACTION_CALL);
        call.setData(Uri.parse("tel:09157925971"));
        if (ActivityCompat.checkSelfPermission(MainActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            return;
        }
        startActivity(call);
    ...
    public void bCALL(View arg0) {
        Intent call = new Intent(Intent.ACTION_CALL);
        call.setData(Uri.parse("tel:09959610619"));
        if (ActivityCompat.checkSelfPermission(MainActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            return;
        }
        startActivity(call);
    ...
    public void CALL(View arg0) {
        Intent call = new Intent(Intent.ACTION_CALL);
        call.setData(Uri.parse("tel:09157925958"));
        if (ActivityCompat.checkSelfPermission(MainActivity.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
            return;
        }
        startActivity(call);
